...
exports.create = async(req) => {
    var inputData= { title: req.title, category: req.category, cover: req.cover, basePrice: parseInt(req.basePrice), description: req.description, review: "", images: [req.url0, req.url1, req.url2]};
